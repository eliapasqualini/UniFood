...
<body>
  ...
  if ($conn->connect_errno) {
    ...
    $query_sql="SELECT * FROM `account` WHERE email = 'fattorino@gmail.com'";
  ...
  <header class="header clearfix">
    ...
    <ul class="header__menu animate">
      <li class="header__menu__item"><a href="index.php">Logout</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-12 col-sm-12 col-help">
        ...
        <div class="buttons">
          ...
          <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" id="button">Elimina account</button></span>
      </div>
    </div>
  </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      <?php
      if($dbErr == "I due indirizzi email non corrispondono!"){
      ?>
